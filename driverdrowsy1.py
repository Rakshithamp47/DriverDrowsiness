...
#from Login import Login_Success_Window
#import mysql.connector
#import Login

#a=Login_Success_Window.delete_login_success

#print(Login_Succss_Window.delete_login_success())
#a=(name.get())
#print(a)
...
def yawn(mouth):
    ...
    print((euclideanDist(mouth[2], mouth[10])+euclideanDist(mouth[4], mouth[8]))/(2*euclideanDist(mouth[0], mouth[6])))
...
while(True):
    ...
    if(len(rects)):
        ...
        if(map_counter>=3):
            ...
            #webbrowser.open("https://www.google.com/maps/search/current+location")
